...
public class ExprParser extends Parser {
	...
	public static final int
		Assign=1, SemiColon=2, LParen=3, RParen=4, LBrace=5, RBrace=6, Comma=7, 
		Not=8, And=9, Or=10, ID=11, INT=12;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "Assign", "SemiColon", "LParen", "RParen", "LBrace", "RBrace", 
			"Comma", "Not", "And", "Or", "ID", "INT"
		};
	}
